...
# define the buttons
button_1 = Button(root, text='1', padx=31, pady=20,
...
button_0 = Button(root, text='0', padx=81, pady=20,
                  command=lambda: button_click(0))
button_dot = Button(root, text='.', padx=33, pady=20,
                    command=lambda: button_click('.'))
button_add = Button(root, text='+', padx=30, pady=20, command=button_add)
button_subtract = Button(root, text='-', padx=30,
                         pady=20, command=button_subtract)
button_multiply = Button(root, text='x', padx=30,
...
button_clear = Button(root, text='Clear', padx=70,
